...
install -d -m 0755 /etc/aster /var/lib/aster/workspace /var/lib/aster/sessions
...
printf 'Installed Aster. Edit /etc/aster/config.json, then run: aster --config /etc/aster/config.json doctor\n'

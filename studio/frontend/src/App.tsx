...
function AccessSettingsDialog({permissionMode, sandboxMode, networkMode, workspaceMode, summary, hasWorkspace, workspaceEligible, workspaceLoading, workspaceReason, hasSandbox, hasNetwork, sandboxAvailable, networkModes, modelOnly, canChangePermissions, canChangeSandbox, canChangeNetwork, busy, onWorkspace, onPermission, onSandbox, onNetwork, onClose}: {
  ...
  return <div className="modal-backdrop"><section className="modal access-settings-modal" role="dialog" aria-modal="true" aria-labelledby="access-settings-title">
    ...
    {boundariesLocked && <div className="access-settings-note"><Info size={14} /><span>The current OS or network boundary is locked for this Agent session. Choose it before starting a new task; approval behavior may still be changed while idle.</span></div>}
